...
const strengths: Record<string, string> = {
  ...
  ops:
    "具备完整的服务器→Linux→数据库→容器→云平台及自动化运维能力，能够独立完成Web应用从环境部署、数据库配置、容器化交付到监控运维的全流程实践；具备扎实的问题分析与故障排查能力，能够结合日志、监控快速定位业务问题。拥有云计算HCIE认证及华为ICT大赛全球一等奖，具备优秀的学习能力和工程实践能力。",
  cloudSecurity:
